<div class="relative" style="background-color: #231f20">
    <div class="flex justify-between items-center p-4 sm:px-4 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
                <span class="sr-only">Workflow</span>
                <img class="h-15 w-auto sm:h-20" src="{{ asset('img/logo.png') }}" alt="">
            </a>
        </div>
        <div class="-mr-2 -my-2 md:hidden">
            <button type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
                ...
                <x-heroicon-o-menu class="h-6 w-6"></x-heroicon-o-menu>
            </button>
        </div>
        <nav class="hidden md:flex space-x-10">
            ...
            <x-site.desktop.nav-link>Início</x-site.desktop.nav-link>
        </nav>
        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a href="https://www.facebook.com/cafedonutsbr" class="inline-flex items-center px-4 py-2 mr-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                <x-bi-facebook class="-ml-2 -mr-2 h-5 w-5" />
            </a>
            <a href="https://www.facebook.com/cafedonutsbr" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                <x-bi-instagram class="-ml-2 -mr-2 h-5 w-5" />
            </a>
        </div>
    </div>
